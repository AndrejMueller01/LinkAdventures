...
/**
 * DefaultLinkValidatorTest.java
 * 
 * test for the class DefaultLinkValidator.java
 * 
 * @author Andrej Mueller
 */
@RunWith(Parameterized.class)
public class DefaultLinkValidatorTest {
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] { { "https://www.test.at", true }, { "http://www.test.at#", false },
				...
				{ "https://me:secret@test.com/wh-assessment-101/invalid.txt", false },
				{ "https://test.com/wh/fragment#invalid", false },
				{ "https://test.com/wh-101/query?invalid=true", false }, { "https://test.com:8080/wh-101", false } });
	}
